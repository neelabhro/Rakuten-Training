...
public class LambdaExample {
	...
	public static void main(String[] args) {
		...
		BiFunction<Integer, Double, Double> f4 = new BiFunction<Integer, Double, Double>() {
		...
		System.out.println(f4.apply(4, 5.0));

		BiFunction<Integer, Double, Double> f5 = (t, u) -> t * u;
		System.out.println(f5.apply(7, 6.0));
